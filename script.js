...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const scrollAnimatedElements = document.querySelectorAll('.feature-box, .course-card, .about-content > *, .about-stats > .stat, .instructor-profile-card, .register-content');
